...
- Product (Kotlin app, Spring Boot): READY, AVAILABLE
- Order (Kotlin app, Spring Boot): WIP
- Inventory (Java app, Spring Boot): TODO
...
## Order App Screenshots
- Project depedencies (two options are pre-included for database migration flexibility)
![dependencies](./assets/omkt/order/dependencies.png)
- Docker services
![docker-compose file](./assets/omkt/order/docker-compose.png)
![Dockerfile](./assets/omkt/order/Dockerfile.png)
